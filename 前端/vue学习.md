...
`ref="subDepartRef"` 为这个组件创建了一个引用，这样在 Vue 的 methods 或 computed properties 中，你可以通过 `this.$refs.subDepartRef` 来访问这个组件的实例。
...
![image-20240309152850612](C:\Users\885767\AppData\Roaming\Typora\typora-user-images\image-20240309152850612.png)

![image-20240309152749324](C:\Users\885767\AppData\Roaming\Typora\typora-user-images\image-20240309152749324.png)

nextTick()刷新页面才能取到值



![image-20240309152917836](C:\Users\885767\AppData\Roaming\Typora\typora-user-images\image-20240309152917836.png)



![image-20240309153639882](C:\Users\885767\AppData\Roaming\Typora\typora-user-images\image-20240309153639882.png)



两个值相等时再显示label的值。注意字符类型

![image-20240325145219045](C:\Users\885767\AppData\Roaming\Typora\typora-user-images\image-20240325145219045.png)

![image-20240325145622788](C:\Users\885767\AppData\Roaming\Typora\typora-user-images\image-20240325145622788.png)

当出现多个参数传值时使用全局参数进行值的传递

![image-20240325145418636](C:\Users\885767\AppData\Roaming\Typora\typora-user-images\image-20240325145418636.png)

绑定数据randomKey，当randomKey刷新时组件里面的值进行重新渲染

![image-20240325145506696](C:\Users\885767\AppData\Roaming\Typora\typora-user-images\image-20240325145506696.png)
